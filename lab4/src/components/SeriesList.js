...
const SeriesList = (props) => {
					...
					<CardActionArea>
						<Link to={`/series/${series.id}`}>
							<CardMedia
								...
								component='img'
								image={series.thumbnail.path ? series.thumbnail.path + "/portrait_xlarge." + series.thumbnail.extension : noImage}
								title='series image'
							/>
    ...
    if (error404){
        return (
			<div>
				<h2>Couldn't find any series on this page, maybe try another</h2>
			</div>
		);
    }
